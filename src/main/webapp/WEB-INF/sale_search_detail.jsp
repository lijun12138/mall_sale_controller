...
<div class="Dbox">
		<div class="box">
			<div class="left">
				<div class="timg"><img src="${sku_spu_tm_value.spu.shp_tp}" alt=""></div>
				<div class="timg2">
					<div class="lf"><img src="images/lf.jpg" alt=""></div>
					<div class="center">
						<c:forEach items="${sku_spu_tm_value.spu_img}" var="image">
							<span><img src="upload/image/${image.url}" height="40px"/></span>
						</c:forEach>
					</div>
			...
			<div class="cent">
				<div class="title">${sku_spu_tm_value.sku_mch}</div>
				<div class="bg">
					<p>市场价：<strong>￥${sku_spu_tm_value.jg}</strong></p>
					<p>促销价：<strong>￥${sku_spu_tm_value.jg}</strong></p>
				</div>
				<div class="clear">
				...
				<div class="clear" style="margin-top:20px;">
						<form  id="cart_form" action="add_cart.do" method="post">
							<input type="hidden" name="sku_mch" value="${sku_spu_tm_value.sku_mch}" />
							<input type="hidden" name="sku_jg" value="${sku_spu_tm_value.jg}" />
							<input type="hidden" name="tjshl" value="1" />
							<input type="hidden" name="hj" value="${sku_spu_tm_value.jg}" />
							<input type="hidden" name="shp_id" value="${sku_spu_tm_value.shp_id}" />
							<input type="hidden" name="sku_id" value="${sku_spu_tm_value.id}" />
							<input type="hidden" name="shp_tp" value="${sku_spu_tm_value.spu.shp_tp}" />
							<input type="hidden" name="shfxz" value="1" />
							<input type="hidden" name="kcdz" value="${sku_spu_tm_value.kcdz}" />
	...
	<div class="Dbox1">
		<div class="boxbottom">
			...
			<div class="btm">
				${sku_spu_tm_value.spu.shp_msh}<br>
				<c:forEach items="${sku_spu_tm_value.spu_img}" var="image">
					<img src="upload/image/${image.url}" height="200px"/>
				</c:forEach>	
				<br>	
				<c:forEach items="${sku_spu_tm_value.sku_av_name}" var="av_name">
