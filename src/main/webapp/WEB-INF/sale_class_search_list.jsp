...
<body>
	...
	<div class="Sbox">
		<c:forEach items="${sku_spu_tm_value}" var="sku_spu_tm">
			<div class="list">
				<div class="img"><img src="upload/image/${sku_spu_tm.spu.shp_tp}" alt="" width="280px" height="150px"></div>
				<div class="price">¥${sku_spu_tm.jg}</div>
				<div class="price">库存：${sku_spu_tm.kc}</div>
				<div class="price">销量：${sku_spu_tm.sku_xl}</div>
